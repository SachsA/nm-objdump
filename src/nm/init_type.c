...
static void weak_type(list_t *new, Elf64_Sym *sym, size_t value)
{
	if (!value) {
...
static void hard_types_bis(list_t *new, Elf64_Sym *sym, Elf64_Shdr *shdr)
{
...
static void hard_types(list_t *new, Elf64_Sym *sym, Elf64_Shdr *shdr)
{
	if ((shdr[sym->st_shndx].sh_type == SHT_PROGBITS &&
...
void init_type(list_t *new, Elf64_Sym *sym, Elf64_Shdr *shdr, size_t value)
{
